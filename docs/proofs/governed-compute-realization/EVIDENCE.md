...
| `unit-compute-execution` (Sprint 5 lifecycle + replay + forged events) | 13 pass / 0 fail |
...
| `unit-compute-adversarial` (Sprint 11 — mismatch/timeout/wrong-checkpoint/hash/cancel/promotion boundary) | 6 pass / 0 fail |
| **Total focused compute tests** | **114 pass / 0 fail** |
