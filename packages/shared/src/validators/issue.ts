...
export const createIssueSchema = z.object({
  ...
  ticketStage: z.string().optional().nullable(),
...
export const batchDelegateIssuesSchema = z.object({
  issues: z.array(createIssueSchema).min(1).max(50),
});

export type BatchDelegateIssues = z.infer<typeof batchDelegateIssuesSchema>;
