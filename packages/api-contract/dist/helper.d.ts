 ...
 */
export type WorkspaceHelperIntent = "build_dashboard" | "create_widget" | "register_api" | "create_object" | "edit_view" | "repair" | "explain" | "swarm";
export declare const WORKSPACE_HELPER_INTENT_VALUES: WorkspaceHelperIntent[];
/**
 ...
 */
export type WorkspaceProposalType = "dashboard.create" | "dashboard.update" | "widgetType.bind" | "canvas.widget.add" | "canvas.tab.create" | "dataModel.object.create" | "dataModel.object.update" | "dataModel.row.add" | "repair.binding" | "explain.object" | "swarm.run.propose" | "swarm.workflow.save" | "swarm.run.resume";
export declare const WORKSPACE_HELPER_PROPOSAL_TYPES: WorkspaceProposalType[];
/**
 ...
 */
export declare const PROPOSAL_TYPE_TO_PATCH_FIELD: Record<WorkspaceProposalType, "dashboards" | "widgetTypes" | "canvas" | "dataModel">;
/**
...
export interface WorkspaceHelperApplyResponse {
    ...
    skipped: Array<{
        proposal: WorkspaceHelperProposal;
        reason: string;
    }>;
...
export declare function isWorkspaceHelperResponse(value: unknown): value is WorkspaceHelperResponse;
export declare function isWorkspaceProposal(value: unknown): value is WorkspaceHelperProposal;
export declare const WORKSPACE_HELPER_CONTRACT_VERSION: 1;
