...
export type PipelineTraceEventType = "pipeline_stage_started" | "pipeline_stage_completed" | "pipeline_stage_failed" | "pipeline_artifact_written" | "pipeline_handoff_created";
/**
...
export type PipelineTraceEvent = PipelineStageStartedEvent | PipelineStageCompletedEvent | PipelineStageFailedEvent | PipelineArtifactWrittenEvent | PipelineHandoffCreatedEvent;
/**
 ...
 */
export declare function isPipelineTraceEvent(value: unknown): value is PipelineTraceEvent;
/**
 ...
 */
export declare const PIPELINE_TRACE_VERSION: 1;
