 ...
 */
export type NodeInputUiHint = "default" | "textarea" | "rich-text" | "password" | "toggle" | "dropdown" | "multi-select" | "file-picker" | "url-or-file" | "json-editor";
/**
 ...
 */
export type NodeInputProviderNeutralIntent = "prompt" | "negative-prompt" | "seed" | "count" | "aspect-ratio" | "duration" | "quality" | "style" | "model" | "reference-image" | "reference-video" | "reference-audio" | "document" | "connection" | "api-key" | "unspecified";
/**
...
export type NodeInputField = TextField | LongTextField | NumberField | BooleanField | SelectField | ArrayField | JsonField | UrlField | FileField | UrlOrFileField;
export type NodeOutputFieldType = "text" | "long-text" | "number" | "boolean" | "array" | "object" | "image" | "video" | "slides" | "audio" | "file" | "unknown";
