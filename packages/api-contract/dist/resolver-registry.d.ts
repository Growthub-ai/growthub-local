 ...
 */
export type ResolverProvenance = "config-driven" | "static-file" | "helper-generated" | "passthrough" | "missing";
...
/** Index artifact kind. */
export declare const RESOLVER_REGISTRY_INDEX_KIND: "growthub-resolver-registry-index-v1";
/** Endpoint manifest kind. */
export declare const RESOLVER_ENDPOINT_MANIFEST_KIND: "growthub-resolver-endpoint-manifest-v1";
/** Resolvers dir (repo-relative inside the workspace app). */
export declare const RESOLVER_REGISTRY_DIR: "lib/adapters/integrations/resolvers";
/** Externalized, agent-readable index artifact (do-not-edit, gated write). */
export declare const RESOLVER_REGISTRY_INDEX_FILE: "lib/adapters/integrations/resolvers/_registry.generated.json";
/** Endpoint manifest artifact (do-not-edit, gated/build write). */
export declare const RESOLVER_ENDPOINT_MANIFEST_FILE: "lib/adapters/integrations/resolvers/_endpoints.generated.json";
/** Base path every governed resolver endpoint is addressable under. */
export declare const RESOLVER_ENDPOINT_BASE: "/api/resolvers";
/**
 ...
 */
export declare const RESOLVER_GENERATED_BANNER: "@growthub-resolver generated \u2014 do not edit; edit the governed api-registry record";
export declare function isResolverRegistryIndex(value: unknown): value is ResolverRegistryIndex;
/** Additive changes keep the literal `1`. */
export declare const WORKSPACE_RESOLVER_REGISTRY_CONTRACT_VERSION: 1;
