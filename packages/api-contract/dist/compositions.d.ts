 ...
 */
export declare function defineComposition(composition: Composition): Composition;
/**
 * Type-narrowing helper for declaring pipeline references.
 * Runtime identity function.
 */
export declare function definePipeline(pipeline: PipelineReference): PipelineReference;
/**
 * Type-narrowing helper for declaring artifact references.
 * Runtime identity function.
 */
export declare function defineArtifact(artifact: ArtifactReference): ArtifactReference;
/**
 ...
 * Runtime identity function.
 */
export declare function defineCapability(capability: CapabilityManifest): CapabilityManifest;
