...
v1 is narrowly scoped by design. See `docs/CMS_SDK_V1.md` for the full surgical plan and `docs/ADAPTER_CONTRACTS_V1.md` for the provider-boundary opt-in.
...
- Worker Kit schemas v1 and v2 are first-class siblings for the workspace starter and export manifest surface.
...
- **Worker Kit** (`./worker-kits`) is the export manifest primitive used by
  the workspace starter.
- **Optional, orthogonal specializations** layer on top: workspace
