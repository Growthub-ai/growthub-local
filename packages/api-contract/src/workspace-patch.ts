...
export type WorkspacePatchAllowedField =
  (typeof WORKSPACE_PATCH_ALLOWED_FIELDS)[number];
...
export type WorkspaceLiveWorkflowField =
  (typeof WORKSPACE_LIVE_WORKFLOW_FIELDS)[number];
...
export type WorkspaceDraftWorkflowField =
  (typeof WORKSPACE_DRAFT_WORKFLOW_FIELDS)[number];
 ...
 */
export type WorkspacePatchViolationCode =
  | "invalid_body"
  | "unknown_field"
  | "full_config_body"
...
// ---------------------------------------------------------------------------
// PATCH rejection envelope (HTTP 422)
// ---------------------------------------------------------------------------
...
export type WorkflowPublishFailureCode =
  | "invalid_body"
  | "object_not_found"
  | "row_not_found"
  | "no_draft"
  | "draft_not_tested"
  | "draft_changed_after_test"
  | "draft_run_not_verified"
  | "invalid_graph"
  | "invalid_config"
  | "read_only"
  | "write_failed";
...
export function isWorkspacePatchPolicyRejection(
  value: unknown,
): value is WorkspacePatchPolicyRejection {
  return (
    typeof value === "object" &&
    value !== null &&
    (value as { error?: unknown }).error === "patch rejected by workspace mutation policy" &&
    Array.isArray((value as { violations?: unknown }).violations)
  );
}

export function isWorkflowPublishSuccess(
  value: unknown,
): value is WorkflowPublishSuccess {
  return (
    typeof value === "object" &&
    value !== null &&
    (value as { ok?: unknown }).ok === true &&
    typeof (value as { version?: unknown }).version === "string" &&
    typeof (value as { publishedSha256?: unknown }).publishedSha256 === "string"
  );
}
 ...
 */
export const WORKSPACE_PATCH_CONTRACT_VERSION = 1 as const;
