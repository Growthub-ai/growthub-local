...
// ---------------------------------------------------------------------------
// JSON and artifact vocabulary
// ---------------------------------------------------------------------------

export type InferenceJsonPrimitive = string | number | boolean | null;

export type InferenceJsonValue =
  | InferenceJsonPrimitive
  | InferenceJsonValue[]
  | { [key: string]: InferenceJsonValue };

export type InferenceJsonObject = { [key: string]: InferenceJsonValue };
...
// ---------------------------------------------------------------------------
// Base model, runtime adapter, and LoRA identity
// ---------------------------------------------------------------------------
...
export type ModelIdentityVerificationStatus =
  | "verified"
  | "unverified"
  | "mismatch"
  | "unavailable";
...
export type SchemaEnforcementStatus =
  | "enforced"
  | "not_requested"
  | "rejected"
  | "failed"
...
export type SchemaOutputValidationStatus =
  | "valid"
  | "invalid"
  | "not_run"
  | "unavailable";
...
// ---------------------------------------------------------------------------
// Gateway and native-prefix cache evidence
// ---------------------------------------------------------------------------

export type InferenceCacheStatus =
  | "HIT"
  | "MISS"
  | "COLD_START"
  | "BYPASS"
...
export type InferenceCacheKind =
  | "gateway-exact"
  | "gateway-semantic"
  | "llama-prefix"
  | "none"
...
// ---------------------------------------------------------------------------
// OpenAPI-backed tool governance and closed-loop audit
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Prefill/decode-disaggregated routing
// ---------------------------------------------------------------------------

export type InferencePhase = "prefill" | "decode";

export type InferencePhasePool =
  | "prefill_pool"
  | "decode_pool"
  | "unified_pool"
  | (string & {});
...
// ---------------------------------------------------------------------------
// Request, verification receipt, and normalized gateway result
// ---------------------------------------------------------------------------
...
export interface InferenceRequest {
  ...
  tool_contract?: { allowed_operation_ids?: string[] };
