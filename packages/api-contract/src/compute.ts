 ...
 */
export type ComputeAvailabilityMode =
  | "local"
  | "on-demand"
  | "queued"
  | "warm"
 ...
 */
export type ComputeAcceleratorClass =
  | "none"
  | "any-gpu"
  | "consumer-gpu"
  | "datacenter-gpu"
...
export type ComputeAllocationStatus =
  | "requested"
  | "queued"
  | "allocated"
  | "running"
...
export const COMPUTE_PROVIDER_ROW_SCHEMA = "growthub-compute-provider-v1" as const;

/** Schema id of the persisted placement decision. */
export const COMPUTE_DECISION_SCHEMA = "growthub-compute-decision-v1" as const;

/** Schema id of the composed receipt evidence block. */
export const COMPUTE_EVIDENCE_SCHEMA = "growthub-compute-evidence-v1" as const;

/** Schema id of the customer-authored compute request snapshot. */
export const COMPUTE_REQUEST_SCHEMA = "growthub-compute-request-v1" as const;

/** Schema id of the server-compiled sealed compute authority. */
export const COMPUTE_AUTHORITY_SCHEMA = "growthub-compute-authority-v1" as const;
...
export function isComputeRequest(value: unknown): value is ComputeRequest {
  ...
  return (
    v.schema === COMPUTE_REQUEST_SCHEMA &&
...
export function isComputeAuthority(value: unknown): value is ComputeAuthority {
  if (!value || typeof value !== "object") return false;
  const v = value as Record<string, unknown>;
  return (
    v.schema === COMPUTE_AUTHORITY_SCHEMA &&
...
export function isComputeProviderRowMetadata(value: unknown): value is ComputeProviderRowMetadata {
  if (!value || typeof value !== "object") return false;
  const v = value as Record<string, unknown>;
  return (
    v.schema === COMPUTE_PROVIDER_ROW_SCHEMA &&
...
export function isComputeDecision(value: unknown): value is ComputeDecision {
  if (!value || typeof value !== "object") return false;
  const v = value as Record<string, unknown>;
  return (
    v.schema === COMPUTE_DECISION_SCHEMA &&
...
export function isComputeEvent(value: unknown): value is ComputeEvent {
  if (!value || typeof value !== "object") return false;
  const v = value as Record<string, unknown>;
  return (
    typeof v.type === "string" &&
    (COMPUTE_EVENT_TYPES as readonly string[]).includes(v.type) &&
    typeof v.at === "string" &&
 ...
 * the literal `1`.
 */
export const WORKSPACE_COMPUTE_CONTRACT_VERSION = 1 as const;
