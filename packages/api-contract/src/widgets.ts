...
// ---------------------------------------------------------------------------
// Grid layout (drag/resize geometry — react-grid-layout compatible)
// ---------------------------------------------------------------------------
 ...
 */
export const WIDGETS_CONTRACT_VERSION = 1 as const;
