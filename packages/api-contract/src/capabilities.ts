...
// ---------------------------------------------------------------------------
// Execution binding + tokens
// ---------------------------------------------------------------------------

export type CapabilityExecutionStrategy =
  | "direct"
  | "sequential-with-persistence"
  | "async_operation";
...
// ---------------------------------------------------------------------------
// Public hosted record (frozen from HostedCapabilityRecord)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Public capability node (frozen from CmsCapabilityNode)
// ---------------------------------------------------------------------------
 ...
 */
export type CapabilityRegistrySource =
  | "hosted"
  | "local-extension"
  | "derived";
