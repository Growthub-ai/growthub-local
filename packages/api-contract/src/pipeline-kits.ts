...
// ---------------------------------------------------------------------------
// Artifact references — the on-disk pipeline state contract
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Adapter mode references — the provider-boundary contract
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Trace expectation — declares what a stage must record
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Stage reference — the unit of pipeline execution
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Output topology — the disk-layout contract
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Pipeline Kit Manifest — the canonical kit-local file
// ---------------------------------------------------------------------------
 ...
 * keep this literal `1`.
 */
export const PIPELINE_KIT_MANIFEST_VERSION = 1 as const;
