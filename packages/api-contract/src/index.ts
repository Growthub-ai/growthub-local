...
// Swarm Run (governed agent-swarm runs — proposal/receipt envelope with
// sandbox-object parity, run/phase/agent graph nodes, NDJSON event
// vocabulary. Executes through the existing workspace sandbox-run surface;
// see docs/GOVERNED_WORKSPACE_TOPOLOGY_V1.md.)
export type {
