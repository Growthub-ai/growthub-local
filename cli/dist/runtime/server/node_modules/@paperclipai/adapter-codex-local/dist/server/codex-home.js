...
export function resolveCodexHomeDir(env = process.env) {
...
export async function prepareWorktreeCodexHome(env, onLog) {
    ...
    await onLog("stdout", `[paperclip] Using worktree-isolated Codex home "${targetHome}" (seeded from "${sourceHome}").\n`);
    return targetHome;
}
