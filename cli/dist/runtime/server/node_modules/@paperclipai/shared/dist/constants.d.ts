...
export declare const SURFACE_PROFILES: readonly ["dx", "gtm"];
...
export declare const TICKET_STAGES: readonly ["planning", "execution", "review", "qa", "human"];
export type TicketStage = (typeof TICKET_STAGES)[number];
export declare const TICKET_STATUSES: readonly ["active", "paused", "done", "cancelled"];
 ...
 */
export declare const PLUGIN_RESERVED_COMPANY_ROUTE_SEGMENTS: readonly ["dashboard", "onboarding", "companies", "company", "settings", "plugins", "org", "agents", "projects", "tickets", "issues", "goals", "approvals", "costs", "activity", "inbox", "design-guide", "tests"];
