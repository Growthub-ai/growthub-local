...
import { createNativeIntelligenceBackend, createNativeIntelligenceProvider, checkBackendHealth, readIntelligenceConfig, writeIntelligenceConfig, buildMarketingContext, buildDeterministicContext, } from "./runtime/native-intelligence/index.js";
...
import { addObservation, addSummary, searchMemory, searchSummaries, listMemoryProjects, getMemoryStats, getObservations, buildMemoryContext, buildSemanticContext, canSync, syncMemoriesToHosted, readProviderConfig, writeProviderConfig, } from "./runtime/memory/index.js";
    ...
    while (true) {
        ...
        if (action === "sync") {
            ...
            if (syncResult.success) {
                syncSpinner.stop(`Synced ${syncResult.syncedObservations} observations and ${syncResult.syncedSummaries} summaries.`);
            }
            else {
