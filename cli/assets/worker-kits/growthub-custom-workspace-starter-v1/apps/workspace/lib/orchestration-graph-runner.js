      ...
      return {
        ...
        adapterMeta: {
          ...
          customModel: {
            ...
            providerStreams: inference.providerStreams || [],
            traces: [],
          },
        },
      };
    ...
    return {
      ...
      adapterMeta: {
        ...
        customModel: {
          ...
          providerStream: inference.providerStream || null,
          invocations: inference.invocations || (inference.invocation ? [inference.invocation] : []),
          providerStreams: inference.providerStreams || (inference.providerStream ? [inference.providerStream] : []),
