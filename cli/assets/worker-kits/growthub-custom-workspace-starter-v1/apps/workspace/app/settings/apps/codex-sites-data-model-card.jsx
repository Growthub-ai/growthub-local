...
function CodexSitesDataModelCard({ apps, dataModel }) {
  ...
  const liveRows = rows.filter((row) => isCodexSiteUrl(row?.url) && row?.status === "live");
  ...
  return <section className="workspace-settings-section workspace-apps-linkage-section">
    <h3>Codex Sites</h3>
