...
async function POST(request) {
  ...
  const withProduct = withMarketplaceProductRegistry(currentConfig, {
    providerId: "vercel",
    ...
    syncResult: {
      ok: true,
      testedAt: now,
      proof: "Vercel Deployments installed by guided deploy flow.",
    },
  });
  const withDirectory = withVercelProjectsDirectory(withProduct, {
