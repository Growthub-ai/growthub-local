...
| --- | --- |
| MCP server `governed-universe` | Runs `npx -y @growthub/cli@0.14.24 serve --mcp --fork .` from the Codex session cwd. |
...
pins `@growthub/cli@0.14.24`; `scripts/check-codex-plugin.mjs` enforces that
