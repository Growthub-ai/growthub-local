...
export const issuesApi = {
  ...
  listArchived: (companyId: string) => api.get<Issue[]>(`/companies/${companyId}/issues/archived`),
  bulkArchive: (companyId: string, ids: string[]) =>
    api.post<{ archived: number }>(`/companies/${companyId}/issues/bulk-archive`, { ids }),
  bulkRestore: (companyId: string, ids: string[]) =>
    api.post<{ restored: number }>(`/companies/${companyId}/issues/bulk-restore`, { ids }),
